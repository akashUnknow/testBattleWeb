...
const NavBar = () => {
  ...
  const examCategories = {
    "SSC Exams": [
      ...
      {
        name: "SSC Head Constable",
        icon: "👮",
        path: "/exams/ssc-head-constable",
      },
      {
        name: "Delhi Police Head Constable",
        icon: "👮",
        path: "/exams/delhi-police-head-constable",
      },
      ...
      { name: "Delhi Police MTS", icon: "👮", path: "/exams/delhi-police-mts" },
      {
        ...
        icon: "🛡️",
        path: "/exams/ib-security-assistant",
      },
      {
        name: "SSC Selection Post",
        icon: "🎯",
        path: "/exams/ssc-selection-post",
      },
      ...
      { name: "SSC JE ME", icon: "🔧", path: "/exams/ssc-je-me" },
      {
        ...
        icon: "🔬",
        path: "/exams/ssc-scientific-assistant",
      },
    ],
    "Banking Exams": [
          ...
          <div className="md:hidden py-4 border-t border-gray-200">
            <div className="space-y-2">
              ...
              <Link
                to="/super-coaching"
                onClick={closeDropdown}
                className="block px-4 py-2 font-medium text-gray-700 hover:bg-gray-100 rounded-lg"
              >
                SuperCoaching
              </Link>
              <Link
