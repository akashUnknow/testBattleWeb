...
const Result = () => {
  ...
  const { total, attempted, correct, scorePercent, name } =
    location.state || {};
        ...
        <div className="w-full h-screen">
          ...
          <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
            ...
            <div
              ...
              } p-4 text-white text-center relative overflow-hidden`}
            >
                ...
                <div className="relative w-40 h-40 mx-auto">
                  <svg className="transform -rotate-90 w-40 h-40">
                    ...
                    <circle
                      ...
                      strokeDashoffset={`${
                        2 * Math.PI * 72 * (1 - scorePercent / 100)
                      }`}
                      className={`${
            ...
            <div className="p-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                {stats.map((stat, index) => (
                  ...
                  >
                    <div
                      className={`${stat.bg} ${stat.color} w-10 h-10 rounded-full flex items-center justify-center mb-2 mx-auto`}
                    >
              ...
              {unattempted > 0 && (
                <div className="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                  <p className="text-yellow-800 text-center text-sm">
                    <strong>{unattempted}</strong> question
                    {unattempted !== 1 ? "s" : ""} left unattempted
                  </p>
                </div>
              )}
            </div>
